...
//fn1 : filename1
//fn2 : filename2
fn bindiff_of_1(fn1: &str, fn2: &str) -> u32 {
    use std::io::Read;
    //b1 : file1 in binary format
    ...
    //If the length of the two files is different the function returns false
    // if b1.len() != b2.len() {
    //     return 0;
    // }

    // println!("{}",b1.into_iter()
    //     .zip(b2.into_iter())
